...
namespace TinyURL.Migrations
{
    ...
    [Migration("20260219104817_AddRawFieldsToRequestLog")]
    partial class AddRawFieldsToRequestLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TinyURL.Models.RequestLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TinyURL.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TinyURL.Models.UrlTag", b =>
                {
            ...
            modelBuilder.Entity("TinyURL.Models.UrlTag", b =>
                {
                    b.HasOne("TinyURL.Models.Tag", "Tag")
                        .WithMany("UrlTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TinyURL.Models.UrlMapping", "UrlMapping")
                        .WithMany("UrlTags")
