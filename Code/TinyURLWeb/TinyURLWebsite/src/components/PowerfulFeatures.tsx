        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-28 space-y-32">
                    ...
                    <div  id="custom-aliases" className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div  id="expiration-control" className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div id="smart-tagging" className="grid lg:grid-cols-2 gap-16 items-center">
