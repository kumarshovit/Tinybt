...
1. Set `TinyBtUrlApi.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../TinyBtUrlApi.Infrastructure/TinyBtUrlApi.Infrastructure.csproj -s TinyBtUrlApi.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../TinyBtUrlApi.Infrastructure/TinyBtUrlApi.Infrastructure.csproj -s TinyBtUrlApi.Web.csproj
```
