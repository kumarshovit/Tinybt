...
**Updated `tests\TinyBtUrlApi.FunctionalTests\TinyBtUrlApi.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\TinyBtUrlApi.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\TinyBtUrlApi.FunctionalTests\TinyBtUrlApi.FunctionalTests.csproj
```
